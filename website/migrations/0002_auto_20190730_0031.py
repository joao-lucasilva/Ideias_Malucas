# Generated by Django 2.2.3 on 2019-07-30 03:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorias', models.CharField(choices=[('T', 'Tecnologia'), ('S', 'Saude'), ('C', 'Culinaria'), ('V', 'Vestimenta'), ('O', 'Outros')], max_length=255, verbose_name='Categorias')),
                ...
                ('pressoa', models.ForeignKey(on_delete=None, to='website.Pessoa')),
            ],
        ),
    ]
